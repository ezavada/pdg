// Simple embedded test for Phase 1 Spriter enhancements
// Tests character maps and basic event system

console.log("Testing Phase 1 Spriter enhancements in embedded environment...");
...
try {
    testCharacterMaps();
    testSpriteMethods();
    console.log("All Phase 1 embedded tests passed!");
} catch (error) {
